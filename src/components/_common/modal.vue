<template>
    <div>
        <div id="myModal" :class="'modal fade '+cls" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display:block">
            <div :class="modalCls" :style="style">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" v-if="footer">
                        <slot name="footer">
                            <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal" @click="forceClose">{{$i('Close')}}</button>
                        </slot>
                    </div>
                </div>
            </div>
