      ...
      <div class="tab-content ">
        ...
        <div v-if="currentTab.tabId == 3" class="tab-pane fade show active">
          ...
          <interviewSetting
            ...
            @previousTab="previousTab" @nextTab="nextTab" @confirmTab="clickTab(5)"
          />
        </div>
        ...
        <div v-if="currentTab.tabId == 5" class="tab-pane fade show active">
          <confirm v-model="objData"
                   :listDataBasicInfo="listDataBasicInfo"
                   :listDataInterview="listDataInterview"
                   @save="edit"
                   @tab="editTab"
          />
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getDetail() {
                ...
                this.getDetailEmployerPost({id: getId})
                    .then(res => {
                      let stations= [{
                            stationId: null,
                            description: '',
