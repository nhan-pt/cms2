                                ...
                                <div class="group-intro-client">
                                    <div class="box-name">
                                        ...
                                        <div class="group-btn__ha">
                                            <a href="javascript:;" title="" class="btn-general__ha color-orange" v-for="e in listIsAvailable" :key="e.id" v-if="e.id==candidateMemberDetail.isAvailable" @click="checkIsAvailable(e.id)"> {{$i(e.label)}}</a>
                                        </div>
                                    </div>
                                    <div class="group-name-client">
                                    ...
                                    <div class="content-candidate-right p-y-15">
                                        <div class="box-row rule justify-content-between">
                                            ...
                                            <div class="group-btn__ha p-x-15">
                                                <a href="javascript:;"  @click="$message($i('function_under_development'), 'warning');" title="" class="btn-general__ha color-orange">{{$i('cms_make_a_phone_call')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-9">
                                    <div class="content-candidate-right p-y-15">
                                        <div class="box-row rule justify-content-between">
                                            ...
                                            <div class="group-btn__ha p-x-15">
                                                <a href="javascript:;"  @click="$message($i('function_under_development'), 'warning');" title="" class="btn-general__ha color-orange" >{{$i('cms_applicant_send_email')}} </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-9">
                                    <div class="content-candidate-right p-y-15">
                                        <div class="group-img-CMND">
                                            <div class="img-thumb">
                                                <img :src="candidateMemberDetail.cardImage1" alt="" class="img-cover">
                                            </div>
                                            <div class="img-thumb">
                                                <img :src="candidateMemberDetail.cardImage2" alt="" class="img-cover">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="group-basicInfo-candidate border-frame">
                        ...
                        <div class="group-row">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <div class="content-candidate-right Nearest p-y-15" v-if="candidateMemberDetail.school.address && candidateMemberDetail.school.address.stations && candidateMemberDetail.school.address.stations.length">
                            ...
                            <div class="group-row">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <div class="content-candidate-right p-y-15">
                                            <div class="box-row rule">
                                                <div class="texts"> {{candidateMemberDetail.memberLanguageName}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <el-dialog :visible.sync="dialogIsAvailable" width="30%">
            <div class="row display-flex">
                <div class="col-12">
                    ...
                    <div class=" group-select">
                        <el-select class="group-select__ha" v-model="changeStatus" :placeholder="$i('cms_status')">
                            <el-option v-for="v in listChangeAvailable" :key="v.id" :label="$i(v.label)" :value="v.id">
                            </el-option>
                        </el-select>
                    </div>
                </div>
            ...
            <div class="row display-flex mt-5">
                <div class="col-12 text-right">
                    <div class=" list-btn__ha">
                        <div class="item-btn">
                            <a href="javascript:;" class="text-links bg-27ACCE" @click="changeStatusId">
                                {{$i('cms_execute')}} </a>
                        </div>
                        <div class="item-btn">
                            <a href="javascript:;" class="text-links bg-b5bbc8" @click="dialogIsAvailable = false">
                                {{$i('Cancel')}} </a>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        ...
        listChangeAvailable() {
            return this.listIsAvailable.filter(e => e.id == CandidateInfoAvailable.AVAILABEL || e.id == CandidateInfoAvailable.WAITINGCONFIRM)
        }
    },
    watch: {
        'tabActive'(value) {
    ...
    methods: {
        ...mapActions(['getDetailCandidateMember','deleteMember', 'confirmCandidateProfile', 'getListApplicationPost', 'updateStatusCandidateIds']),
        ...
        checkIsAvailable(id) {
            if (id == CandidateInfoAvailable.AVAILABEL || id == CandidateInfoAvailable.WAITINGCONFIRM) this.dialogIsAvailable = true
        },
        changeStatusId() {
        ...
        edit() {
            return this.$router.push('/candidatemember/edit/' + this.$route.params.id);
        },
        clickTab(item) {
            if (item == 6) {
                this.$message(this.$i('function_under_development'), 'warning');
            } else {
                this.listTab.map(e => {
                    e.status = 'deactive'
                })
        ...
        //Delete
        deleteEvent() {
            this.$confirm(this.$i('DoYouWantDelete')).then(() => {
