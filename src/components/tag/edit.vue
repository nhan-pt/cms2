    ...
    <div>
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-12" v-if="this.tagId">
                    <div class="form-group">
        ...
        <div class="form-group">
            <button class="btn btn-primary"
                    v-on:click="saveEditTag()">
                <span v-if="tagId">{{ $i('Update') }}</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['getTagDetail', 'updateTag', 'addTag', 'getLanguages']),
            getLangs() {
            ...
            getTag() {
                if (this.tagId > 0) {
                    this.objData.id = this.tagId;
                    this.getTagDetail(this.objData).then(res => {
                        this.objData = res;
            ...
            saveEditTag() {
                ...
                let link = this.tagId ? 'updateTag' : 'addTag';
